...
# ── Épingler les deux raccourcis à la barre des tâches ──────
...
Copy-Item "$bureau\$newName.lnk"                "$taskbarDir\$newName.lnk"                -Force
Write-Host "Raccourcis épinglés à la barre des tâches."
